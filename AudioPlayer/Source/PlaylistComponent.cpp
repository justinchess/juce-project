                                        ...
                                        playerForParsingMetaData(_playerForParsingMetaData)
{
	...
	addAndMakeVisible(addToPlayer3Button);
	...
	addToPlayer3Button.addListener(this);
...
void PlaylistComponent::resized()
{
    ...
    addToPlayer1Button.setBounds(0, 15 * getHeight() / 16, getWidth() / 3, getHeight() / 16);
    addToPlayer2Button.setBounds(getWidth() / 3, 15 * getHeight() / 16, getWidth() / 3, getHeight() / 16);  
	addToPlayer3Button.setBounds(getWidth() * 2 / 3, 15 * getHeight() / 16, getWidth() / 3, getHeight() / 16);
    //set columns
...
void PlaylistComponent::buttonClicked(juce::Button* button)
{
	...
	else if (button == &addToPlayer3Button)
	{
		DBG("Add to Player 3 clicked");
		loadInPlayer(deckGUI3);
	}
    else
    {
...
void PlaylistComponent::loadInPlayer(DeckGUI* deckGUI)
{
    ...
    if (selectedRow != -1)
    {
        ...
        deckGUI->loadFile(tracks[selectedRow].URL, tracks[selectedRow].file.getFullPathName());
    }
    else
    {
